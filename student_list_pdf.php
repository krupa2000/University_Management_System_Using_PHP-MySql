...
$iubat='University Management System' ;				
       ...
       // $pdf->Write(4,'Developed by Md Abul Kalam');
		...
		$pdf-> Cell(20);
		$pdf->SetFont('Times','',8);
		$pdf->Write(4, 'Nadiad-Petlad Highway, Changa 388 421 Anand, Gujarat, INDIA');
				$pdf->Ln();
		$pdf-> Cell(20);
		$pdf->SetFont('Times','',8);
		$pdf->Write(4,'Phone: 01837237303, Email: krupa20@gmail.com');
		$pdf->Ln();
		$pdf-> Cell(20);
		$pdf->SetFont('Times','',8);
		$pdf->Write(4,'Web: https://charusat.ac.in');
		$pdf-> Cell(20);
		$pdf->SetFont('Times','',8);
